...
func (_m *Device) CreateDevice(d domain.Device) error {
	ret := _m.Called(d)
...
func (_m *Device) DeleteDevice(_a0 string) error {
	ret := _m.Called(_a0)
...
func (_m *Device) GetDevice(_a0 string) (domain.Device, error) {
	ret := _m.Called(_a0)
...
func (_m *Device) UpdateDevice(_a0 domain.Device) error {
	ret := _m.Called(_a0)
